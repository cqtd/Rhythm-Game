...
namespace Rhythm.UI
{
	public class GearUI : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			m_songText.SetText($"{Game.Instance.header.title}");
			m_artistText.SetText(Game.Instance.header.artist);
		}

		private void Update()
		{
			float x = m_scaler.referenceResolution.x / Screen.width;
			float y = m_scaler.referenceResolution.y / Screen.height;
